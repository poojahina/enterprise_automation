...
public static class DefaultData
{
    ...
    [
        ...
        new() { Id = "stage-6", Name = "PRD Creation", Order = 6, IsEnabled = true, RolesAllowed = """["Product Owner","Solution Architect"]""" },
        new() { Id = "stage-7", Name = "Solution Designed", Order = 7, IsEnabled = true, RolesAllowed = """["Solution Architect"]""" },
