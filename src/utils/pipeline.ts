...
const pipelineStages: PipelineConfigStage[] = [
  ...
  { name: 'PRD Creation', route: '/pdd', status: 'PRD Creation', aliases: ['PDD Creation'] },
  { name: 'Solution Designed', route: '/sdd', status: 'Solution Designed', aliases: ['Solution Design', 'SDD Creation'] },
